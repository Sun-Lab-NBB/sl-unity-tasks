...
///
/// Manages display attachment to actors and camera culling mask configuration for proper VR rendering.
/// </summary>
using UnityEngine;
#if UNITY_EDITOR
using UnityEditor;
...
namespace Gimbl
{
    /// <summary>Manages a VR display with brightness control and actor attachment.</summary>
